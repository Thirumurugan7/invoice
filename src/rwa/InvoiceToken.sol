...
interface IInvoiceRegistryMetadata {
...
///         Freely transferable: any wallet may hold, buy or sell invoice tokens.
contract InvoiceToken is ERC20 {
    ...
    function contractURI() external view returns (string memory) {
        return string.concat("data:application/json;utf8,", IInvoiceRegistryMetadata(registry).invoiceMetadata(invoiceId));
    }
}
