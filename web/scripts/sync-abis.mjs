...
const names = { registry: 'InvoiceRegistry', risk: 'CreditRiskModel', vault: 'CollateralVault', hook: 'MaturityCurveHook', market: 'TegataMarket', token: 'InvoiceToken', jpyc: 'MockJPYC', customRevert: 'CustomRevert', hooks: 'Hooks' };
const abis = {};
